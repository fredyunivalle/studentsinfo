...
const infoJsonPath = path.join(__dirname, '../public/data/2042893/info.json');

describe('Verificación del archivo info.json en la carpeta 2042893', () => {
...
describe('Validación de la estructura de info.json en la carpeta 2042893 - Estudiante: Estefania Parra', () => {
