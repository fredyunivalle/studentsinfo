...
const infoJsonPath = path.join(__dirname, '../public/data/2041425/info.json');

describe('Verificación del archivo info.json en la carpeta 2041425', () => {
...
describe('Validación de la estructura de info.json en la carpeta 2041425 - Estudiante: Daniel Celis', () => {
