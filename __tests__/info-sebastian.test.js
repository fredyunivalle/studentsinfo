...
const infoJsonPath = path.join(__dirname, '../public/data/2040991/info.json');

describe('Verificación del archivo info.json en la carpeta 2040991', () => {
...
describe('Validación de la estructura de info.json en la carpeta 2040991 - Estudiante: Sebastian Rey', () => {
