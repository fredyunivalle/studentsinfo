...
const infoJsonPath = path.join(__dirname, '../public/data/2310117/info.json');
...
describe('Validación de la estructura de info.json en la carpeta 2310117 - Estudiante: Cristian Medina', () => {
